// API definition for Rtone Cordova BLE plugin.
//
...
* @property {number} bond - The device's bond state.
...
* @param {boolean} autoConnect - autConnect parameter, true or false.
...
*/
exports.connect = function(address, autoConnect, passkey, win, fail) {
	exec(win, fail, 'BLE', 'connect', [address, autoConnect, passkey]);
};
...
rtone.ble.readCharacteristic(
	...
	function(data)
	{
		console.log('BLE characteristic data: ' + rtone.ble.fromUtf8(data));
	},
	function(errorCode)
	{
...
rtone.ble.readDescriptor(
	...
	function(data)
	{
		console.log('BLE descriptor data: ' + rtone.ble.fromUtf8(data));
	},
	function(errorCode)
	{
